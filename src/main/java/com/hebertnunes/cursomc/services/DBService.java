...
public class DBService {
	...
	public void instantiateTesteDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "hebertcunha1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Pagamento pagt2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/07/2017 00:00"), null);
